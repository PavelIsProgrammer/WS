        ...
        binding.apply {
            ...
            pair.second.forEach {
                ...
                check.setOnCheckedChangeListener { _, b ->
                    val analysis = pair.second.toMutableList().find { findItem -> findItem.catalogItem.id == it.catalogItem.id }
                    analysis?.selected = b

                    eventListener.analysisCheckedChanged(pair.first, analysis!!)
                }
