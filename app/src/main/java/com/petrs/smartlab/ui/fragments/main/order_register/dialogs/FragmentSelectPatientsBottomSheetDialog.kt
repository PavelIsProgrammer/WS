...
class FragmentSelectPatientsBottomSheetDialog(
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        Log.d(TAG, params.patients.toString())
        ...
        newPatients.forEach { patientItem ->
            ...
            text.apply {
                ...
                setOnClickListener {
                    newPatients.find { findItem -> findItem.profile == patientItem.profile }?.selected =
                        !newPatients.find { findItem -> findItem.profile == patientItem.profile }?.selected!!
    ...
    private fun validate() {
        binding.apply {
            if (newPatients.find { it.selected } != null) {
                ...
                btnConfirm.background = ContextCompat.getDrawable(
                    requireContext(),
                    R.drawable.filled_btn
                )
            } else {
